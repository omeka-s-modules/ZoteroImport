 ...
 */
class ZoteroImportItem extends \ZoteroImport\Entity\ZoteroImportItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ZoteroImportItem $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setImport(\ZoteroImport\Entity\ZoteroImport $import)
    {
