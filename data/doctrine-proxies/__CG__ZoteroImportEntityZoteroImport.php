...
namespace DoctrineProxies\__CG__\ZoteroImport\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class ZoteroImport extends \ZoteroImport\Entity\ZoteroImport implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'job', 'undoJob', 'name', 'url', 'version', 'importItems'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ZoteroImport $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setUndoJob(\Omeka\Entity\Job $undoJob)
    {
    ...
    public function getImportItems()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getImportItems', []);

        return parent::getImportItems();
    }
